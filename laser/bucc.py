...
if args.threshold > 0:
    ...
    bitexts = BuccExtract(candidate2score, args.threshold, args.output)
    if args.gold:
        ...
        print(' - test threshold={:f}: precision={:.2f}, recall={:.2f}, F1={:.2f}'
              .format(args.threshold, 100*precision, 100*recall, 100*f1))
elif args.gold:
    if args.verbose:
